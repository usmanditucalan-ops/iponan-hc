  ...
  return (
    <header className="h-auto min-h-[72px] bg-white/95 dark:bg-dark-surface-primary/95 backdrop-blur-md border-b border-border dark:border-dark-border py-2 px-3 md:px-4 flex items-center justify-between sticky top-0 z-20 lg:ml-64 shadow-sm transition-all duration-200">
      ...
      <button
        ...
        className="lg:hidden p-2 -ml-1 mr-2 hover:bg-surface-tertiary dark:hover:bg-dark-surface-tertiary rounded-xl transition-colors text-text-secondary dark:text-dark-text-secondary"
      ...
      <div className="flex items-center gap-1.5 md:gap-2 shrink-0 ml-2">
        <button
          ...
          className="p-2 text-text-secondary dark:text-dark-text-secondary hover:bg-surface-tertiary dark:hover:bg-dark-surface-tertiary rounded-lg transition-colors outline-none"
        >
        ...
        <div className="relative">
          <button
            ...
            className="relative p-2 text-text-secondary dark:text-dark-text-secondary hover:bg-surface-tertiary dark:hover:bg-dark-surface-tertiary rounded-lg transition-colors outline-none"
          >
            <Bell size={18} />
        ...
        <div className="relative ml-1">
          <button
            ...
            className="flex items-center gap-2 px-2.5 py-1.5 rounded-xl border border-border dark:border-dark-border hover:bg-surface-tertiary dark:hover:bg-dark-surface-tertiary transition-colors focus:outline-none"
          >
          ...
          {isProfileOpen && (
            <>
              ...
              />
              <div className="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-dark-surface-secondary rounded-xl shadow-lg border border-border dark:border-dark-border py-2 z-20 flex flex-col">
