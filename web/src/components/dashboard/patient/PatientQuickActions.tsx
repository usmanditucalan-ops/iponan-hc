    ...
    <div className="bg-white dark:bg-dark-surface-secondary rounded-[11px] shadow-sm border border-gray-100 dark:border-dark-border p-6 flex flex-col w-full md:h-[360px] h-auto overflow-hidden">
      ...
      <div className="flex flex-col gap-4">
        ...
        <button
          ...
          className="w-full h-[84px] rounded-[11px] bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white flex gap-4 items-center px-5 transition-all shadow-md hover:shadow-lg active:scale-[0.98]"
        >
