...
export const ConfirmationDialogComponent: React.FC<ConfirmationDialogProps> = ({ dialog }) => {
  ...
  return (
    <div className="fixed inset-0 z-[160] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200" role="presentation">
      <div
        className="bg-white dark:bg-dark-surface-secondary w-full max-w-md rounded-xl shadow-xl dark:shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <div className={`p-6 border-b border-border dark:border-dark-border flex items-center justify-between ${
          ...
          <button
            className="p-2 hover:bg-white/50 dark:hover:bg-dark-surface-tertiary rounded-md transition-colors text-text-muted dark:text-dark-text-muted-dark focus:ring-2 focus:ring-primary dark:focus:ring-dark-primary focus:ring-offset-2 dark:focus:ring-offset-dark-surface-secondary outline-none"
        ...
        <div className="p-8 text-center space-y-6">
          ...
          <div className="flex gap-3 justify-center">
            <button
              ...
              className="px-6 py-3 text-text-secondary dark:text-dark-text-secondary font-bold text-sm hover:bg-surface-secondary dark:hover:bg-dark-surface-tertiary rounded-md transition-all disabled:opacity-50 disabled:cursor-not-allowed focus:ring-2 focus:ring-primary dark:focus:ring-dark-primary focus:ring-offset-2 dark:focus:ring-offset-dark-surface-secondary outline-none"
            >
            ...
            <button
              ...
              disabled={dialog.isLoading}
              className={`px-8 py-3 text-white font-bold text-sm rounded-md transition-all duration-200 flex items-center justify-center gap-2 min-w-[140px] disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90 active:scale-95 focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-dark-surface-secondary outline-none ${
                isDangerous
